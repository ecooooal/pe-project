...
use App\Http\Controllers\ReviewerController; // ✅ ADD THIS
...
Route::prefix('student')->middleware(['can:view student'])->group(function () {
    Route::get('/', fn () => view('students/student-home'));
    Route::get('/exams', fn () => view('students/exams/index'));
    Route::get('/exams/exam.id', fn () => view('students/exams/show'));
    Route::get('/exams/exam.id/mcq-example', fn () => view('students/exams/mcq-example'));
    Route::get('/exams/exam.id/torf-example', fn () => view('students/exams/TorF-example'));
    Route::get('/exams/exam.id/iden-example', fn () => view('students/exams/iden-example'));
...
Route::prefix('')->middleware(['can:view faculty'])->group(function () {
    ...
    Route::group(['middleware' => ['can:view access control']], function () {
        ...
        Route::get('/admins/roles', fn () => view('admins/roles'));
        ...
        Route::get('/admins/permissions', fn () => view('admins/permissions'));
    ...
    Route::delete('/reviewers/{id}', [ReviewerController::class, 'destroy']);


    // ✅ Other reviewer views (you can convert to controller later if needed)
    Route::get('/reviewers/show', fn () => view('reviewers/show'));
    Route::get('/reviewers/edit', fn () => view('reviewers/edit'));
    Route::get('/reviewers/questions', fn () => view('reviewers/questions'));
    ...
    Route::get('/profiles/show', fn () => view('profiles/show'));
    Route::get('/profiles/subjects', fn () => view('profiles/subjects'));
    Route::get('/profiles/courses', fn () => view('profiles/courses'));
});
